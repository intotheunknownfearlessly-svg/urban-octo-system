    ...
    export async function builderAgent(payload: AgentPayload): Promise<AgentResult> {
      const summary = await runLLM({
        system: "You are a staff engineer. Produce implementation tasks, risk list, and integration checklist.",
